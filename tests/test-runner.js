...
const TestRunner = {
    ...
    expect: function(actual) {
        return {
            ...
            toContain: (substring) => {
                if (!actual.includes(substring)) throw new Error(`La chaîne ne contient pas "${substring}". Valeur: "${actual.substring(0, 50)}..."`);
            },
...
// Exposer globalement pour faciliter l'écriture des tests
