...
*/        
        ...
        // Adaptation dynamique du chemin selon la version (Flask vs Static)
        let cfgPath = '/static/py/MyCFG.py'; // Chemin par défaut (Flask)
        if (typeof IS_STATIC_VERSION !== 'undefined' && IS_STATIC_VERSION) {
             cfgPath = 'MyCFG.py'; // Chemin pour la version statique (racine)
        }
